...
void SetupH1437SurvivalParameters()
{
	...
	TFile* dySpectrumFile = TFile::Open("/home/joseph/Dropbox/Documents/Work/Projects/MDA_vitro_RBE/Data/LinealFYSpectraApril2023CellStudy_1e3nm.root");
...
void Fifth_Beta()
{
	...
	std::cout << std::endl << "QE2" << std::endl;
	std::vector<double> QE2Guesses{0.05105616, -0.000213757, 6.97354e-05};
	QE2BWF.SetValues(QE2Guesses);
	BWFFitter.SetAlphaWeightingFunction(QE2BWF);
	FifthBWF.SetValues(std::vector<double> {0,-5.7889e-09, 5.35126e-06, -0.000225948, 0.000604568, 0.0404976});
	BWFFitter.SetBetaWeightingFunction(FifthBWF);
	BWFFitter.Initialize();
	auto QE2Results = BWFFitter.Fit();
	QE2Results.PrintRMSEMinusPenaltyFunction(penaltyWeight, 105);
