...
void Fixed_Beta()
{
	...
	QuadraticBWF.SetValues(std::vector<double> {0, 0.00866631, 0.157321});
	...
	CubicBWF.SetValues(std::vector<double> {0, 0.00120034, -0.027305, 0.202759});
	...
	FourthBWF.SetValues(std::vector<double> {0, 1.04327e-08, 0.00119395, -0.0277663, 0.203196});
	...
	FifthBWF.SetValues(std::vector<double> {0, 4.45702e-10, 1.82527e-08, 0.00118993, -0.0280507, 0.203621});
	...
	LEBWF.SetValues(std::vector<double> {0, 0., 0.0139333});
	...
	QEBWF.SetValues(std::vector<double> {0, 0.0, 0.000873803});
	...
	LQEBWF.SetValues(std::vector<double> {0, 0.0, 0.000873803, 0.0139333});
	...
	LE2BWF.SetValues(std::vector<double> {0, 0., 0.0139333});
	...
	QE2BWF.SetValues(std::vector<double> {0, 0.0, 0.000873803});
	...
	LQE2BWF.SetValues(std::vector<double> {0, 0.0, 0.000873803, 0.0139333});
